...
public class MovimientosPDFExporter {
	...
	public MovimientosPDFExporter(List<Insumo> listInsumos) {
		super();
	...
	private void writeTableHeader(PdfPTable table) {
		...
		cell.setPhrase(new  Phrase("Entradas", font));
		cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(cell);
		
		cell.setPhrase(new  Phrase("Salidas", font));
		cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(cell);
	...
	private void writeTableData(PdfPTable table) {
		for (Insumo insumo : listInsumo) {
			...
			table.addCell(String.valueOf(insumo.getEntradas()));
			table.addCell(String.valueOf(insumo.getSalidas()));
		}
	...
	public void export(HttpServletResponse response) throws DocumentException, IOException {
		...
		Paragraph title = new Paragraph("Lista de movimientos", font);
